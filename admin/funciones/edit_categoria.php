...
if (isset($_POST['editado'])) {
    ...
    // $editar_correo = $_POST['edit_correo']; // Eliminado: no parece que estés usando una columna 'EmailId' en tu tabla

    $query = "UPDATE categoria SET Categoria ='$editar_nombre' WHERE id = $id"; // Corregido: quitar 'EmailId' si no es necesario
...
<body>
    ...
    <h1>Editar información de la categoría</h1>
