...
if (isset($_POST['value'])) {
    ...
    if (empty($nombre) || empty($correo) || empty($password)) {
        echo '<script>alert("Todos los campos son obligatorios");window.location="registrar_usuario.php"</script>';
    }
    ...
    // caso contrario en caso de que si llene los campos puede registrase
        ...
        $query = "INSERT INTO usuarios (FullName, EmailId, Passwo) VALUES (?, ?, ?)";
        ...
        if ($funciona) {
            echo '<script>alert("Funciona");window.location = "registrar_usuario.php";</script>';
        } else {
            echo '<script>alert("No funciona");window.location = "registrar_usuario.php";</script>';
        }
    }
}
